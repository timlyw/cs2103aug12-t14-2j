...
public class GoogleCalendarTester {
	...
	public void testCrud() throws IOException, ServiceException {
		...
		CalendarEventEntry addedEvent = gCal.createEvent(taskTitle, taskStartStr, taskEndStr);
		...
		boolean isStartTimeEqual = compareTimeStr(newTaskStartStr, updatedTaskStartStr);
		boolean isEndTimeEqual = compareTimeStr(newTaskEndStr, updatedTaskEndStr);
