...
//
///**
// * This class tests the functionality of GoogleCalendar for creation, retrieval,
...
//
//	/**
//	 * test if the retrieved access token is not empty when email and password
//	 * is valid
//	 * 
...
//	 */
//	@Test
//	public void testRetrieveAccessToken() throws AuthenticationException,
//			NullPointerException, UnknownHostException {
//		String accessToken;
//		accessToken = GoogleCalendarMhs.retrieveUserToken(APP_NAME, USER_EMAIL,
//				USER_PASSWORD);
//		assertTrue(accessToken.length() > 0);
//	}
//
//	@Test
//	public void testMoveEvent() throws NullPointerException, IOException,
//			ServiceException {
//		String accessToken;
//		accessToken = GoogleCalendarMhs.retrieveUserToken(APP_NAME, USER_EMAIL,
//				USER_PASSWORD);
//		GoogleCalendarMhs gCal = new GoogleCalendarMhs(APP_NAME, USER_EMAIL,
//				accessToken);
//
//		String startTime = "2013-07-01T13:00:00+08:00";
//		String endTime = "2013-07-30T15:00:00+08:00";
//		List<CalendarEventEntry> taskList = gCal.retrieveEvents(startTime,
//				endTime);
//		display(taskList);
//		for (int i = 0; i < taskList.size(); i++) {
//			String isDeleted = Boolean
//					.toString(gCal.isDeleted(taskList.get(i)));
//			display(isDeleted);
//		}
//	}
//
...
//	 */
//	@Test
//	public void testCrudForEvents() throws NullPointerException, IOException,
//			ServiceException {
//		String accessToken;
//		accessToken = GoogleCalendarMhs.retrieveUserToken(APP_NAME, USER_EMAIL,
//				USER_PASSWORD);
...
//
//		List<CalendarEventEntry> initialList = gCal.retrieveEvents(startTime1,
//				endTime2);
//
...
//
//		List<CalendarEventEntry> newList = gCal.retrieveEvents(startTime1,
//				endTime2);
...
//
//	/**
//	 * Test the creation, retrieval, update and delete methods for
//	 * GoogleCalendarMhs
//	 * 
//	 * 1) create a task "mhs test time calendar" on 12 Jan 2013, 11pm to 13 Jan
//	 * 2012, 1am 2) retrieve the task using GoogleCalendarMhs and check whether
//	 * the retrieved parameters match the parameters used for creation 3) update
//	 * the task title, start and end time 4) retrieve the task again and check
//	 * if the parameters match the parameters used to update the task 5) delete
//	 * the task and try to retrieve it with GoogleCalendarMhs 6) check that the
//	 * retrieve method for the task now returns null
//	 * 
//	 * @throws NullPointerException
//	 * @throws IOException
//	 * @throws ServiceException
//	 */
//	@Test
//	public void testCrudForSingleEvent() throws NullPointerException,
...
//		String retrievedStartTime = GoogleCalendar
//				.getEventStartTime(retrievedTask);
...
//
//		TimedTask updatedTask = createTask(updatedTitle, updatedStartTime,
//				updatedEndTime);
...
//
//		CalendarEventEntry retrievedUpdatedTask = gCal
//				.retrieveEvent(updatedEventId);
//		String retrievedUpdatedTitle = GoogleCalendar
//				.getEventTitle(retrievedUpdatedTask);
//		String retrievedUpdatedStartTime = GoogleCalendar
//				.getEventStartTime(retrievedUpdatedTask);
//		String retrievedUpdatedEndTime = GoogleCalendar
//				.getEventEndTime(retrievedUpdatedTask);
//
//		assertEquals(updatedTitle, retrievedUpdatedTitle);
//		assertTrue(GoogleCalendar.isTimeEqual(updatedStartTime,
//				retrievedUpdatedStartTime));
//		assertTrue(GoogleCalendar.isTimeEqual(updatedEndTime,
//				retrievedUpdatedEndTime));
...
//	public void testInvalidLoginParameters() throws NullPointerException,
//			IOException, AuthenticationException {
//		GoogleCalendarMhs.retrieveUserToken(APP_NAME, "invalid email",
//				"invalid password");
//	}
//
//	/**
