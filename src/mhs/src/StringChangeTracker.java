...
public class StringChangeTracker {
	...
	public String getPreviousString(String currText) {
		...
		String previousString = currText.substring(0, startChangeIndex)
				+ changedString + currText.substring(endChangeIndex);
	...
	public Change getChange(String oldText, String newText) {
		...
		String previousString = oldText.substring(startChangeIndex,
				oldEndChangeIndex + 1);
		Change change = new Change(startChangeIndex, newEndChangeIndex,
				previousString);
		return change;
	}
	...
	public int getNewEndChangeIndex(String oldText, String newText) {
		...
		do {
			...
			indexWithinRange = (oldCharIndex > 0) && (newCharIndex > 0);
