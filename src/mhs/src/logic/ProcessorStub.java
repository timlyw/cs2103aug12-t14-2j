...
public class ProcessorStub {
	...
	private void populateEvents() {
		/*
		 * String boldEventTitle =
		 * htmlCreator.makeBold("Event Title [COMPLETED]"); String startDate =
		 * "12 Oct 2012 3pm"; String endDate = "15 Oct 2012 7pm";
		 * 
		 * currentState = boldEventTitle + " " + startDate + " - " + endDate +
		 * htmlCreator.NEW_LINE;
		 * 
		 * for(int i = 0; i < lineLimit; i++) { currentState += "event" +
		 * Integer.toString(i); currentState += htmlCreator.NEW_LINE; }
		 * 
		 * currentState += "end";
		 */
	...
	private TimedTask createTimedTask(String title, String startTime,
			String endTime) {
