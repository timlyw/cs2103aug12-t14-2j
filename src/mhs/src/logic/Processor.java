 ...
 * 
 *         This class processes the given user input and takes an action accordingly. It also return
 *         the necessary output to the UI
 */
  ...
  public void executeCommand() {
    ...
    try {
      if (usernameIsExpected) {
        ...
        try {
          userCommand = commandParser.getParsedCommand(currentCommand);
