...
public class TimeExtractor {
	 ...
	 * 
	 * @param time This is the string to be processed. 
	 * 
	 ...
	 * 
	 * @param time This is the string to process. 
	 */
	private void process24hrFormat(String time) {

		String[] timeArray = new String[2];
		timeArray = time.split(":");
		setTime = new LocalTime(Integer.parseInt(timeArray[0]),Integer.parseInt(timeArray[1]));
	 ...
	 *  
	 * @param timeArray This is an array with time format. 
	 * 
	 ...
	 * 
	 * @param timeArray This is an array with the time format. 
	 * 
	 ...
	 * @param timeArray This is an array with the time format. 
	 * 
	 * @param i This is the index to where AM is. 
	 * 
	 ...
	 * @param timeArray This is an array with the time format. 
	 * 
	 * @param i This is the index to where PM is. 
	 * 
	 ...
	 * 
	 * @param time This is the string to be checked. 
	 * 
